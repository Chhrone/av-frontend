...
const KonsonanInventoryModel = {
  ...
  description:
    "Meskipun banyak konsonan Bahasa Inggris memiliki padanan yang mirip dalam Bahasa Indonesia, ada perbedaan krusial—baik dalam bentuk bunyi yang baru maupun cara pengucapan bunyi yang familiar—yang secara signifikan memengaruhi kejelasan dan kealamian aksen.",
  banner: {
    title: "Inventaris Konsonan",
  ...
  commonMistakes: [
    {
      ...
      description:
        'Karena bunyi "th" tidak ada dalam Bahasa Indonesia, penutur cenderung menggantinya dengan bunyi terdekat, biasanya /t/, /d/, atau /f/.',
    ...
    },
    {
      ...
      description:
        "Ada kecenderungan kuat untuk mengganti konsonan bersuara dengan padanan tak bersuaranya, terutama di akhir kata.",
      examples: [
        'very (/ˈvɛri/) → "fery"',
        'zoo (/zuː/) → "soo"',
        'have (/hæv/) → "haf"',
    ...
    },
    {
      ...
      description:
        "Menggunakan /r/ getar atau guling (trilled r) khas Indonesia untuk semua konteks /r/ dalam Bahasa Inggris, padahal seharusnya menggunakan American /r/ yang ditarik ke belakang.",
    ...
    },
    {
      ...
      description:
        'Mengucapkan "pin", "ten", dan "come" tanpa hembusan udara yang diperlukan, sehingga dapat terdengar seperti "bin", "den", dan "gum" bagi penutur asli.',
  ...
  practiceItems: [
    {
      ...
      instruction:
        "Latih bunyi /θ/ vs /t/: think vs tink, three vs tree, path vs pat.",
    },
    {
      id: "KI-002",
      title: "Latihan /ð/ dan /d/",
      instruction:
        "Latih bunyi /ð/ vs /d/: then vs den, they vs day, breathe vs breed.",
    },
    {
      id: "KI-003",
      title: "Latihan /r/ Gaya American",
      instruction:
        'Latih American /r/: Ucapkan "car", "bird", "right", "run". Rasakan lidah tertarik ke belakang tanpa bergetar.',
    },
    {
      id: "KI-004",
      title: "Latihan Aspirasi /p/, /t/, /k/",
      instruction:
        'Latihan aspirasi: Pegang kertas di depan mulut. Ucapkan "pay", "take", "key". Kertas harus bergerak. Lalu ucapkan "spay", "stake", "sky". Kertas tidak boleh bergerak.',
    },
    {
      id: "KI-005",
      title: "Latihan Konsonan Bersuara di Akhir Kata",
      instruction:
        'Latih konsonan bersuara di akhir kata: "live", "have", "buzz", "prize". Rasakan getaran di tenggorokan hingga akhir.',
    },
  ],
  moreMaterials: {
    ...
    materials: [
      {
        ...
        description:
          "Video tutorial yang sangat jelas dan detail tentang cara memproduksi bunyi /θ/ dan /ð/ dengan benar.",
        url: "https://www.youtube.com/watch?v=nlKNo1TGALA",
        type: "youtube",
        icon: "📺",
      },
      {
        ...
        description:
          "Penjelasan tertulis dan audio tentang cara membentuk bunyi /r/ Amerika, lengkap dengan daftar kata untuk latihan.",
        url: "https://pronuncian.com/pronounce-r-sound",
        type: "website",
        icon: "🌐",
      },
      {
        id: "mat3",
        title: "Pronunciation Studio - Aspiration on /p,t,k/",
        description:
          "Artikel dan latihan audio yang berfokus pada aspirasi, menjelaskan kapan harus dan tidak harus menggunakannya.",
        url: "https://pronunciationstudio.com/sessions/aspiration/",
        type: "website",
        icon: "🌐",
      },
    ],
