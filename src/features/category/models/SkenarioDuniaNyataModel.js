  ...
  constructor() {
    this.data = {
      ...
      banner: {
        ...
        image: 'https://placehold.co/800x300/E2E8F0/475569?text=Skenario+Percakapan'
      },
      material: {
      ...
      pronunciationExamples: [
        { word: "I'd like a medium iced latte", phonetic: "/aɪd laɪk ə ˈmiːdiəm ˈaɪst ˈlɑːteɪ/" },
        { word: "We've finished the initial research", phonetic: "/wiv ˈfɪnɪʃt ði ɪˈnɪʃəl ˈriːsɜːrtʃ/" },
        { word: "I'd like to schedule a check-up", phonetic: "/aɪd laɪk tə ˈskɛdʒuːl ə ˈtʃɛkʌp/" },
        { word: 'What are the next steps?', phonetic: '/wət ɑːr ðə nɛkst stɛps/' }
      ],
      practiceItems: [
        { 
          id: 'RL-001',
          title: 'Perkenalan Formal dan Informal',
          instruction: 'Latih memperkenalkan diri dalam situasi formal dan informal.' 
        },
        { 
          id: 'RL-002',
          title: 'Memesan Makanan di Restoran',
          instruction: 'Rekam suara Anda saat memesan makanan di restoran imajiner.' 
        },
        { 
          id: 'RL-003',
          title: 'Simulasi Rapat Tim',
          instruction: 'Praktikkan dialog rapat tim dengan fokus pada intonasi profesional.' 
        },
        { 
          id: 'RL-004',
          title: 'Membuat Janji via Telepon',
          instruction: 'Coba buat janji temu melalui telepon dengan suara yang jelas dan tenang.' 
        },
        { 
          id: 'RL-005',
          title: 'Percakapan di Bandara',
          instruction: 'Latih skenario check-in di bandara: menyapa petugas, menunjukkan tiket, dan bertanya soal gerbang keberangkatan.' 
        }
      ],      
      commonMistakes: [
        {
          ...
          examples: ["Salah: 'You are a student.' (turun) vs Benar: 'You are a student?' (naik)"]
        },
        {
          id: 'mistake2',
          title: 'Ucapan Terpotong-potong',
          description: 'Gagal menghubungkan kata-kata (linking) membuat percakapan terdengar tidak alami dan kaku.',
          examples: ["Salah: 'Can. I. have. it?' vs Benar: 'Can I have it?' (terdengar seperti /kənaɪhævɪt/)"]
        }
      ],
      moreMaterials: {
        ...
        materials: [
          {
            ...
            description: 'Kumpulan pertanyaan percakapan berdasarkan topik untuk latihan mandiri.',
          ...
          },
          {
            ...
            description: 'Analisis percakapan nyata yang membedah pelafalan, linking, dan intonasi penutur asli.',
